...
public class SyncAttributeTreeModelFactoryTest
{
	...
	public void createTree() throws Exception
	{
		...
		final ComposedTypeModel root = createSpy("rootNode");
		final SyncAttributeDescriptorConfigModel att1 = TreeModelTestUtils.createAndAddSyncAttribute(root, "attribute1");
	 ...
	 */
	@Test
	public void shouldCreateTreeWithOneAttributesAndTwoSubNodes() throws Exception
	{
		//given
		final Collection<SyncAttributeDescriptorConfigModel> attributes = new ArrayList<>();

		final ComposedTypeModel rootType = createSpy("rootNode");
		final ComposedTypeModel node1 = createSpy("node1");
		final ComposedTypeModel node2 = createSpy("node2");
		addChildNode(rootType, node1);
		addChildNode(rootType, node2);

		final SyncAttributeDescriptorConfigModel att1 = TreeModelTestUtils.createAndAddSyncAttribute(rootType, "attribute1");
		final SyncAttributeDescriptorConfigModel att2 = TreeModelTestUtils.createAndAddSyncAttribute(rootType, "attribute2");
		final SyncAttributeDescriptorConfigModel att3 = TreeModelTestUtils.createAndAddSyncAttribute(node1, "attribute3");
		final SyncAttributeDescriptorConfigModel att4 = TreeModelTestUtils.createAndAddSyncAttribute(node1, "attribute4");
		final SyncAttributeDescriptorConfigModel att5 = TreeModelTestUtils.createAndAddSyncAttribute(node2, "attribute5");
	...
	*/
	@Test
	public void shouldCreateTreeWithSubNodeWithAnotherSubNode() throws Exception
	{
		//given
		final Collection<SyncAttributeDescriptorConfigModel> attributes = new ArrayList<>();
	...
	*/
	@Test
	public void shouldCreateTreeWithSubNodeWithAnotherSubNodeWhereParentIsNotDirect() throws Exception
	{
		//given
		final Collection<SyncAttributeDescriptorConfigModel> attributes = new ArrayList<>();
	...
	{
		// given
		final SyncTypeAttributeDataTreeNode node1 = createMockNode("1", true);
		final SyncTypeAttributeDataTreeNode node2 = createMockNode("2", false);
		final SyncTypeAttributeDataTreeNode node3 = createMockNode("3", false);

		final SyncTypeAttributeDataTreeNode node4 = createMockNode("6", true);
		final SyncTypeAttributeDataTreeNode node5 = createMockNode("5", true);
		final SyncTypeAttributeDataTreeNode node6 = createMockNode("4", false);
		...
		map.put(key1, Lists.newArrayList(node1, node2, node3));
		map.put(key2, Lists.newArrayList(node4, node5, node6));

		// when
		SyncAttributeTreeModelFactory.sortMapValuesLists(map);

		// then
		assertThat(map.get(key1)).containsExactly(node2, node3, node1);
		assertThat(map.get(key2)).containsExactly(node6, node5, node4);
	}
