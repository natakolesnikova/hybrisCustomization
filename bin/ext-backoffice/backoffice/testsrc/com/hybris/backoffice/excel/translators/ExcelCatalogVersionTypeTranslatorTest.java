...
public class ExcelCatalogVersionTypeTranslatorTest extends AbstractTypeTranslatorTest
{
	...
	public void setUp()
	{
		...
		translator.setTypeService(typeService);
	}
	...
	public void shouldExportedDataBeInProperFormat()
	{
		...
		final CatalogVersionModel catalogVersion = generateMock(id, version);
	...
	@Ignore("No sense, we would only test mocked typeService")
	@Override
	@Test
	...
	public void shouldImportCatalogVersion()
	{
		...
		final ImportParameters importParameters = new ImportParameters(ProductModel._TYPECODE, null, null, UUID.randomUUID()
				.toString(), parameters);
