		...
		implements Converter<Map<String, String>, MediaContainerModel>
{
	...
	public MediaContainerModel convert(final Map<String, String> source)
	{
		...
		final String languagueTag = (String) getCloneComponentContextProvider().findItemForKey(SESSION_CLONE_COMPONENT_LOCALE);
		final MediaContainerModel mediaContainerModel = cloneComponentModel.getMedia(Locale.forLanguageTag(languagueTag));
		...
		Sets.newHashSet(mediaModelMap.keySet()).forEach(mediaFormat -> {
			...
			final Optional<Entry<String, Object>> mediaCodeExistsInBothMaps = findMediaCodeExistsInSourceAndAttributeMap(
					srcAttributeMap, languagueTag, mediaFormat, mediaCode);
	...
	protected Optional<Entry<String, Object>> findMediaCodeExistsInSourceAndAttributeMap(final Map<String, Object> srcAttributeMap,
			final String languagueTag, final String mediaFormat, final String mediaCode)
	{
		final Map<String, Object> srcLocalizedAttributeMap = (Map<String, Object>) srcAttributeMap.get(languagueTag);
