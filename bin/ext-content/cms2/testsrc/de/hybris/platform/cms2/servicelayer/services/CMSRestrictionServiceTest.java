...
public class CMSRestrictionServiceTest extends ServicelayerTest
{
	 ...
	 */
	protected void prepareTimeRestrictionMocks(final int before, final int after)
	{
		...
		EasyMock.expect(mockTimeRestriction.getUseStoreTimeZone()).andReturn(Boolean.TRUE);
	 ...
	 *           given user
	 */
	protected void prepareUserRestrictionMocks(final UserModel user)
	{
	 ...
	 *           given user group
	 */
	protected void prepareUserGroupRestrictionMocks(final UserGroupModel userGroup)
	{
	 ...
	 *           given catalog
	 */
	protected void prepareCatalogGroupRestrictionMocks(final CatalogModel catalog)
	{
	 ...
	 *           given category
	 */
	protected void prepareCategoryRestrictionMocks(final CategoryModel category)
	{
	 ...
	 *           given product
	 */
	protected void prepareProductRestrictionMocks(final ProductModel product)
	{
	 ...
	 *           indicates how many days after now will set as activeTo
	 */
	protected void prepareInverseTimeRestrictionMocks(final int before, final int after)
	{
