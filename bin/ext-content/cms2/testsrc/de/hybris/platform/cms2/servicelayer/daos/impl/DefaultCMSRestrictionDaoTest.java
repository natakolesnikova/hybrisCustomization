...
public class DefaultCMSRestrictionDaoTest extends ServicelayerTransactionalTest
{
	...
	{
		final AbstractRestrictionModel categoryRestriction = cmsRestrictionDao.findRestrictionById(categoryRestrictionCode,
				catVersion);
	...
	{
		final AbstractRestrictionModel productRestriction = cmsRestrictionDao.findRestrictionById(productRestrictionCode,
				catVersion);
		final List<ProductModel> products = cmsRestrictionDao
				.findProductsByRestriction((CMSProductRestrictionModel) productRestriction);
