...
public class DefaultCMSNavigationServiceTest
{
	...
	public void setUp()
	{
		...
		Mockito.when(cmsAdminSiteService.getActiveCatalogVersion()).thenReturn(catalogVersionModel);

		Mockito.when(cmsNavigationDao.findRootNavigationNodes(Arrays.asList(catalogVersionModel)))
