...
{
	/**
	 * Get a synchronization status by {@link SyncJobRequestData}.
	 *
	...
	/**
	 * Get the status of the last synchronization job by {@link SyncJobRequestData}. Information is retrieved based on the catalog version target.
	 *
	 * @param syncJobRequest
	 * 				the synchronization request data
	 * @return the {@link SyncJobData}
	 ...
	 */
	SyncJobData getLastSynchronizationByCatalogTarget(SyncJobRequestData syncJobRequest) throws ValidationException;
	 ...
	 */
	SyncJobData createCatalogSynchronization(SyncJobRequestData syncJobRequest)
