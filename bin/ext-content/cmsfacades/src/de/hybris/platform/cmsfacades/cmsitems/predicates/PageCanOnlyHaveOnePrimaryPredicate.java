...
/**
 * Predicate to test if a given page, when a variant page, should only ever have on primary page
 * <p>
 * Returns <tt>TRUE</tt> if it should only have one primary; <tt>FALSE</tt> otherwise.
 * </p>
 */
