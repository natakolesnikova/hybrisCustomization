...
public interface CMSItemFacade
{
	 ...
	 *
	 * @param uuids The list of uuids of the CMSItems to look for
	 ...
	 * Optionally filter by name/uid or typeCode
	 *
	 * @param cmsItemSearchData The catalog and filter information
	 * @param pageableData      The paging information
	 * @return A SearchResult containing the paging information and the results
	 * @throws de.hybris.platform.cmsfacades.exception.ValidationException When catalog or paging information is missing
	 */
	 ...
	 * For more information about Unique Identifiers, see {@link de.hybris.platform.cmsfacades.uniqueidentifier.UniqueItemIdentifierService}
	 *
	 * @param uuid - the universal unique identifier
	 * @return the {@code Map<String, Object>} representation of the CMS Item
	 * @throws CMSItemNotFoundException - when a CMS Item can not be found for a given {@code uuid}.
	 */
	 ...
	 *
	 * @param itemMap - the {@code Map<String, Object>} that contains the attributes values for the new CMSItem.
	 ...
	 * @param uuid    - the universal unique identifier
	 * @param itemMap - the {@code Map<String, Object>} that contains the attributes values for the new CMSItem.
	 * @return the Map tha represents the CMS Item.
	 * @throws CMSItemNotFoundException - when a CMS Item can not be found for a given {@code uuid}.
	 */
	Map<String, Object> validateItemForUpdate(final String uuid, final Map<String, Object> itemMap) throws CMSItemNotFoundException;
