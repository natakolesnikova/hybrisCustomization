...
public class DefaultSynchronizationFacade implements SynchronizationFacade
{
	...
	private Validator createCatalogSynchronizationCompositeValidator;
	...
	@Override
	public SyncJobData getSynchronizationByCatalogSourceTarget(final SyncJobRequestData syncJobRequest) throws ValidationException
	{
	...
	@Override
	public SyncJobData getLastSynchronizationByCatalogTarget(final SyncJobRequestData syncJobRequest) throws ValidationException
	{
	...
	@Override
	public SyncJobData createCatalogSynchronization(final SyncJobRequestData syncJobRequest)
	{
		getFacadeValidationService().validate(getCreateCatalogSynchronizationCompositeValidator(), syncJobRequest);
	...
	protected Validator getCreateCatalogSynchronizationCompositeValidator()
	{
		return createCatalogSynchronizationCompositeValidator;
	}

	@Required
	public void setCreateCatalogSynchronizationCompositeValidator(final Validator createCatalogSynchronizationCompositeValidator)
	{
		this.createCatalogSynchronizationCompositeValidator = createCatalogSynchronizationCompositeValidator;
	}
