...
public class DefaultItemSynchronizationService implements ItemSynchronizationService
{
	 ...
	 *
	 * @param syncInfo the list of {@link SyncItemInfo}, including the root syncItemInfo
	 */
	 ...
	 *
	 * @param syncItemJob the sync item job being investigated.
	 ...
	 *
	 * @param item    the item of which we want to retrieve the related items from a synchronization perspective
	 * @param context the configuration context in which the item collector will be executed
	 * @return
	 */
	 ...
	 *
	 * @param syncRequestData the requested direction for the synchronization from a catalog version perspective
	 * @param item            the catalog aware item from which a catalog version is extracted
	 * @return
	 */
	 ...
	 * @throws IllegalArgumentException if the direction could not be determined because of both catalog versions being active or inactive
	 */
	...
	/**
	 * @param syncRequestData the requested direction for the synchronization from a catalog version perspective
	 * @param item            the catalog aware item for which a synchronization status is returned
	 * @param relatedItems    the collected related items to the main item
	 * @param syncInfo        the list of {@link SyncItemInfo} for the given relatedItems
	 * @param rootSyncInfo    the {@link SyncItemInfo} of the main item
