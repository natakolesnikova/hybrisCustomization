...
public class CatalogVersionModelMother extends AbstractModelMother<CatalogVersionModel>
{
	...
	protected CatalogVersionModel createContentCatalogVersionModelByIdAndVersion(final CatalogTemplate catalogId, final CatalogVersion version)
	{
	...
	protected CatalogVersionModel createProductCatalogVersionModelByIdAndVersion(final CatalogTemplate catalogId, final CatalogVersion version)
	{
		return getFromCollectionOrSaveAndReturn(() -> getCatalogVersionDao().findCatalogVersions(catalogId.name(), version.getVersion()),
				() -> CatalogVersionModelBuilder
