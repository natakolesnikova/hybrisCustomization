...
public class DefaultPageFacadeTest
{
	...
	public void shouldFailCreate_PageDataPopulatorNotFound()
	{
		...
		// Act
		defaultPageFacade.createPage(pageData1);
	...
	public void shouldFailCreate_PageModelPopulatorNotFound()
	{
		...
		verify(pageInitializer).initialize(contentPageModel);
	}
	...
	public void shouldCreatePageUsingDefaultValidator()
	{
		...
		// Act
		final AbstractPageData result = defaultPageFacade.createPage(pageData1);
	...
	public void shouldUpdatePage()
	{
		...
		// Act
		defaultPageFacade.updatePage(PAGE_UID, pageData1);
	...
	public void shouldGenerateUidWithPrefix()
	{
		...
		defaultPageFacade.setUidPrefix(DefaultPageFacade.DEFAULT_UID_PREFIX);

		// Act
		pageData.setUid(defaultPageFacade.generateUID(pageData.getUid()));
	...
	public void shouldGenerateUidWithoutPrefix()
	{
		// Setup
		final AbstractPageData pageData = new AbstractPageData();
		defaultPageFacade.setUidPrefix(null);
	...
	{
		// Act
		final String result = defaultPageFacade.generateUID(PAGE_UID);

		// Assert
		assertThat(result, Matchers.is(PAGE_UID));
	}
