...
public class RenderingPageConverterIntegrationTest extends BaseIntegrationTest
{
	...
	private final String SIMPLE_CMS_COMPONENTS_KEY = "simpleCMSComponents";
	...
	protected void hasValidABTestComponentData(final AbstractCMSComponentData componentData)
	{
		...
		final List<String> nestedComponents = (List<String>) componentData.getOtherProperties().get(SIMPLE_CMS_COMPONENTS_KEY);
