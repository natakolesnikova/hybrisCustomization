...
public class DefaultPageDisplayConditionServiceTest
{
	...
	public void setUp()
	{
		...
		displayConditionService.setCmsSupportedPages(cmsSupportedPages);
	}
	...
	public void shouldGetDisplayConditions()
	{
		...
		assertThat(displayConditions, iterableWithSize(2));

		assertThat(displayConditions,
				hasItem(allOf( //
						hasProperty(TYPECODE, equalTo(ContentPageModel._TYPECODE)),
						hasProperty(OPTIONS, contains(optionData1, optionData2)))));
		assertThat(displayConditions, 
				hasItem(allOf( //
						hasProperty(TYPECODE, equalTo(ProductPageModel._TYPECODE)), 
						hasProperty(OPTIONS, contains(optionData3)))));
	}
