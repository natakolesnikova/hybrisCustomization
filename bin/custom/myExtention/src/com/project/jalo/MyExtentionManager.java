...
/**
 * This is the extension manager of the MyExtention extension.
 */
public class MyExtentionManager extends GeneratedMyExtentionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MyExtentionManager.class);
	 ...
	 */
	public static MyExtentionManager getInstance()
	{
		return (MyExtentionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MyExtentionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyExtentionManager() // NOPMD 
	{
		LOG.debug("constructor of MyExtentionManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MyExtentionManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MyExtentionManager called, current tenant: {}", getTenant().getTenantID());
	}
