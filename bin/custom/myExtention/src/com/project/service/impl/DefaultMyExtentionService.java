...
public class DefaultMyExtentionService implements MyExtentionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMyExtentionService.class);
	...
	{
		return DefaultMyExtentionService.class.getResourceAsStream("/myExtention/sap-hybris-platform.png");
	}
