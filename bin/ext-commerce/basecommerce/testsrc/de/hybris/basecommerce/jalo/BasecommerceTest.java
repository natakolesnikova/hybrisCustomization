...
public class BasecommerceTest extends ServicelayerTest
{
	...
	public static void createDefaultCatalog() throws Exception
	{
		...
		final CatalogVersion version = modelService.getSource(catalogVersionService.getCatalogVersion("testCatalog", "Online"));
		...
		final Product product = modelService.getSource(productService.getProductForCode("testProduct0"));
	...
	public void createOrder() throws InvalidCartException, Exception
	{
		...
		final ComposedType dmType = modelService.getSource(typeService.getComposedTypeForClass((ZoneDeliveryModeModel.class)));
