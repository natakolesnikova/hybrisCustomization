...
/**
 * Adjust the test for row parameters (CT-1346)
 */
@Ignore
public class FacetParamsTest extends AbstractIntegrationTest
{
	...
	public void testFacetLimitParam() throws Exception
	{
		...
		{
			Assert.assertTrue("Number of facet values should be less than or equal 2 due to applied limitation",
					facet.getFacetValues().size() <= 2);
		}
	}
