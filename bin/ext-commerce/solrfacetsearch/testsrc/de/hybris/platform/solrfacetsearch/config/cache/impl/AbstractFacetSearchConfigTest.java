...
@Ignore
public abstract class AbstractFacetSearchConfigTest extends ServicelayerTest
{
	...
	protected void importConfig(final String resource, final String encoding, final String testId)
			throws IOException, ImpExException
	{
