...
public class DefaultTicketEventEmailTest extends AbstractTicketsystemTest
{
	...
	public void testCreateTicket()
	{
		...
		final Iterator emailIter = smtpServer.getReceivedEmails().iterator();
	...
	public void testUpdateTicketAssignedAgentThroughUpdateTicket()
	{
		...
		ticketParameter.setAssignedGroup(testGroup);
		ticketParameter.setCategory(CsTicketCategory.NOTE);
		ticketParameter.setHeadline("Ticket Headline");
		ticketParameter.setInterventionType(CsInterventionType.CALL);
		ticketParameter.setCreationNotes("Ticket Creation Notes");
		ticketParameter.setCustomer(testUser);
		final CsTicketModel ticket = ticketBusinessService
				.createTicket(ticketParameter);
		assertNotNull(ticket);
