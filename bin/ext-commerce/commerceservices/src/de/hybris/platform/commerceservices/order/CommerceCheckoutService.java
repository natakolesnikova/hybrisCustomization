...
{
	/**
	 * @deprecated Since 5.2. Use {@link #setDeliveryAddress(de.hybris.platform.commerceservices.service.data.CommerceCheckoutParameter)} instead
	 *
	...
	/**
	 * @deprecated Since 5.2. Use {@link #validateDeliveryMode(de.hybris.platform.commerceservices.service.data.CommerceCheckoutParameter)} instead
	...
	/**
	 * @deprecated Since 5.2. Use {@link #setPaymentInfo(de.hybris.platform.commerceservices.service.data.CommerceCheckoutParameter)} instead.
	...
	/**
	 * @deprecated Since 5.2. Use {@link #authorizePayment(de.hybris.platform.commerceservices.service.data.CommerceCheckoutParameter)}
	 ...
	 * @deprecated Since 5.2. Use {@link #placeOrder(de.hybris.platform.commerceservices.service.data.CommerceCheckoutParameter)} instead
	...
	/**
	 * @deprecated Since 5.2. Use {@link #removeDeliveryMode(de.hybris.platform.commerceservices.service.data.CommerceCheckoutParameter)} instead
	...
	/**
	 * @deprecated Since 5.2. Use {@link #calculateCart(de.hybris.platform.commerceservices.service.data.CommerceCheckoutParameter)} instead.
	 *
